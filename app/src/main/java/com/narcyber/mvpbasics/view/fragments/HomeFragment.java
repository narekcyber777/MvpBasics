    ...
    public void inIt(View view) {
        ...
        CityAdapter cityAdapter = new CityAdapter(new CityAdapter.CityAdapterCallBack() {
            ...
            public void onClick(String city) {
                HomeFragmentDirections.ActionHomeFragmentToWeatherActivity navAction =
                        HomeFragmentDirections.actionHomeFragmentToWeatherActivity();
                navAction.setCityWeather(city);
